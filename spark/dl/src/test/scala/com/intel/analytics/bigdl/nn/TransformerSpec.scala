...
class TransformerLayerSpec extends FlatSpec with Matchers {
  ...
  "tranformer for translation 111" should "work correctly" in {
    ...
    val logits = transformer.setSymbols(maxDecodeLength, encoder_outputs,
      encoder_decoder_attention_bias, ids, i = 0)
    ...
    require(logits.almostEqual(expectedOutput, 1e-6) == true)
  }
