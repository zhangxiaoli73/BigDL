...
class TransformerLayerSpec extends FlatSpec with Matchers {
  ...
  "tranformer for translation 111" should "work correctly" in {
        ...
        paramsTable.get[Table](i).get[Tensor[Float]]("weight").copy(
          Tensor[Float](
            T(T( 0.2906804,  -0.09650522, -0.51867586,  0.12019378,  0.04821312,  0.46652162),
              T(-0.64988756,  0.02888119,  0.57290435,  0.3135442,   0.5520284,  -0.5747767),
    ...
    val encoder_outputs = Tensor[Float](
      T(T(T( 2.436518,   -0.9176346,  -0.7922576,  -1.609453,    1.2981114,
        -3.452308),
        T( 2.6172175,  -1.1418103,   0.47855863, -0.37405556,  2.193162,
          -3.0902112),
        T(-0.4836258,  -0.5760815,   1.7006541,  -1.6498369,  -0.25864232,
          -1.3167876),
        T( 0.06332062,  0.8742228,  -1.6509287,   1.7170856,   1.3523861,
        0.7537415),
        T( 1.3512839,  -1.0255917,  -0.18433534, -1.4036541,  -0.40183213,
        0.7955332),
        T(-1.0374911,  -0.59513026, -1.0307591,  -1.2678084,  -1.0068692,
          -0.0189969)),

        T(T(-1.6759655,   0.35162354,  2.4897032,   1.1130662,  -0.2877533,
          -1.3314434),
          T(-1.1207374,   2.538682,    0.07621163, -0.95549345,  0.28637323,
        3.1503828),
        T( 0.18023843,  0.9258047,   0.45025548, -0.5283748,  -1.7137773,
          -0.52401406),
        T(-0.31334135,  0.8799348,   1.2584751,   1.3966532,   0.428381,
        1.3277117),
        T(-1.1315969,   1.8793023,   0.76939476, -0.44713926,  0.73277724,
          -0.11335757),
        T( 1.6974441,   2.2797253,   3.2783632,  -2.0947444,  -2.1661706,
          -0.7566988)),

        T(T( 0.2400556,   1.3142533,   0.47345242, -3.0333018,  -0.45930603,
        1.241962),
        T( 0.3451421,   1.1430168,  -0.33349222, -0.3011371,   0.27984208,
        0.6150775),
        T( 0.2974496,   0.17851298, -1.0059935,   0.5663457,   0.18273191,
        1.6942259),
        T( 1.7983768,   0.27773464, -0.5629274,  -0.9580956,   0.6352415,
        0.1160101),
        T(-0.5157805,   0.06539529, -0.93000126,  1.0470481,  -0.67069286,
        1.8367616),
        T( 0.6052375,   0.8903678,  -1.6423677,   0.25407365,  1.1108347,
          -1.4305509)),

        T(T(-0.39932775,  0.04892182, -2.059676,    0.4727391,   1.269241,
          -1.2892739),
          T( 0.52581894, -1.9684252,  -0.05804326, -2.4236586,   1.6821265,
        0.6133508),
        T(-0.03692544, -1.1627424,   1.9106339,   2.9506526,  -2.7869728,
        1.854246),
        T( 2.441476,    0.50701755, -1.798902,    1.295018,   -0.27138045,
          -0.9058809),
        T(-1.8450872,   0.82580626,  1.1892103,  -0.9352961,   0.7808645,
          -1.7165121),
        T( 1.2027916,   0.06985094, -0.27985466, -0.15261881,  1.3033292,
        1.1256175)),

        T(T( 0.794198,    0.20655182,  0.11673169,  0.9275704,   0.34874183,
        1.0238271),
        T(-0.46517515, -3.6522567,   1.558237,    3.2804694,   0.6620467,
          -0.15023285),
        T(-0.20466712, -0.17858128,  0.02611411, -1.6830281,  -0.7756417,
          -1.4955403),
        T( 0.37319875, -0.44496173,  0.742817,   -0.26205474,  1.4795028,
        0.32030085),
        T( 3.2860496,  -2.8445413,  -0.97037506,  1.3522303,   3.7924886,
          -0.37295216),
        T( 0.06550349, -0.33947137,  1.9971857,  -0.4309618,   1.0201048,
          -0.4797024)),

        T(T(-1.9088382,   0.47032157,  0.7547772,   1.9398388,  -0.16567054,
          -0.9260431),
          T( 0.84414166,  0.36110565,  0.42099762, -0.10966905,  1.7405078,
        0.5542391),
        T( 2.856988,    1.6665851,   0.9885747,  -2.4411576,   0.9034789,
        0.6304233),
        T( 1.2164276,   1.5666631,  -0.6013173,   1.2360084,  -0.8434582,
        2.932317),
        T(-1.9979275,  -2.641033,   -2.4760818,  -1.3358334,  -1.6786731,
        2.9341183),
        T(-0.48974925, -2.0140138,   1.6715745,  -0.8797859,  -1.85528,
        1.3137584)))
    )
    ...
    val ids = Tensor[Float](T(T(0), T(1), T(3),T(2), T(3), T(0)))

//    def setSymbols(maxDecodeLength: Int, encoder_outputs: Tensor[T],
//                   encoder_decoder_attention_bias: Tensor[T], ids: Tensor[T], i: Int)
    val maxDecodeLength = 10

    val m1 = transformer.setSymbols(maxDecodeLength, encoder_outputs, encoder_decoder_attention_bias, ids, i = 0)
