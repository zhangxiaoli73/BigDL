...
//      "000000000802.jpg", "000000000872.jpg", "000000000885.jpg")
  ...
  def main(args: Array[String]): Unit = {
    testParser.parse(args, TestParams()).foreach { param => {
      ...
      val url = "/home/zhangli/CodeSpace/forTrain/coco-2017/coco-seq-0.seq"
...
//       rddData.count()
//       println(s"data set read done ${rddData.partitions.length}")
      ...
      val transformer = MTImageFeatureToBatchWithResize(
          sizeDivisible = 32,
          batchSize = batchSize,
          transformer = BytesToMat() -> // PixelBytesToMat()
      ...
      testMiniBatch(evaluationSet, model)
