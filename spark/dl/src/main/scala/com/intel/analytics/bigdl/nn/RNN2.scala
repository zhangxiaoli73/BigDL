...
class RnnCell2[T : ClassTag] (
  ...
  val i2h = LinearNew[T](inputSize, hiddenSize,
      wRegularizer = wRegularizer, bRegularizer = bRegularizer)
  val h2h = LinearNew[T](hiddenSize, hiddenSize,
  ...
  /**
    ...
    * @return
    */
  override def clearState(): RnnCell2.this.type = {
    super.clearState()
    cell.clearState()
    this
  }

  override def canEqual(other: Any): Boolean = other.isInstanceOf[RnnCell2[T]]

  override def equals(other: Any): Boolean = other match {
    case that: RnnCell2[T] =>
      super.equals(that) &&
        (that canEqual this) &&
...
object RnnCell2 {
  def apply[@specialized(Float, Double) T: ClassTag](
    ...
    hiddenSize: Int = 3,
    activation: TensorModule[T])
  (implicit ev: TensorNumeric[T]) : RnnCell2[T] = {
    new RnnCell2[T](inputSize, hiddenSize, activation)
  }
}
